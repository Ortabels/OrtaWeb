...
date: 2026-05-01
description: "Concevoir collectivement des supports pédagogiques ludiques et manipulables afin de sensibiliser les enfants au sol vivant et à l’agroécologie, en favorisant l’apprentissage concret et le lien social."
tags: ["sol vivant", "agroécologie", "pédagogie ludique", "éco-responsabilité"]
author: "Jérémy"
---
...
{{< figure
  src="projets/creationdoutilspedagogiques/création-doutilspédagogiques/img/bocaux.png"
  alt="Bocaux d'observation avec strates de sol"
  caption="Bocaux d’observation : visualiser la texture et la stratification."
>}}

{{< figure
  src=""projets/creationdoutilspedagogiques/création-doutilspédagogiques/img/strat-sol.png"
...
{{< timeline >}}
  {{< timelineItem icon="users" header="Mobiliser les bénévoles" subheader="Préparation, fabrication, finitions" >}}
  Réunir un groupe de 3 à 5 bénévoles pour un chantier collectif réparti en trois phases : 
  - préparation (1 semaine) 
  - fabrication (1 à 3 jours)
  - finitions (1 jour)
  {{< /timelineItem >}}
  {{< timelineItem icon="toolbox" header="Rassembler le matériel" >}}
  ...
  {{< /timelineItem >}}
  {{< timelineItem icon="triangle-exclamation" header="Assurer la sécurité" >}}
  ...
  {{< /timelineItem >}}
  {{< timelineItem icon="euro-sign" header="Estimer le budget" badge="200–330 €" >}}
  Prévoir un budget global compris entre 200 € et 330 €, en favorisant la récupération pour limiter les coûts.
  {{< /timelineItem >}}
  {{< timelineItem icon="camera" header="Documenter le projet" >}}
  Assurer une documentation pour valoriser le projet et faciliter sa diffusion.
  {{< /timelineItem >}}
  {{< timelineItem icon="school" header="Animer et pérenniser" subheader="Écoles locales" >}}
