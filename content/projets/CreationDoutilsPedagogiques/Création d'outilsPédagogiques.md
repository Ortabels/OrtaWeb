...
{{< timeline >}}
  ...
  Réunir un groupe de **10 à 15 bénévoles** pour un chantier collectif réparti en trois phases : préparation (**1 semaine**), fabrication (**1 journée**), finitions (**1 à 3 jours**).
  {{< /timelineItem >}}
  ...
  Assurer une **documentation photographique** pour valoriser le projet et faciliter sa diffusion.
  {{< /timelineItem >}}
