...
<p data-hover="expand">
  Ici, chaque racine, chaque pierre et chaque goutte de pluie participent à une même histoire&nbsp;: celle d’un <strong>jardin qui ne s’arrête jamais</strong>, qui mûrit avec le temps, au rythme des saisons et des personnes qui l’habitent.
</p>
...
<div style="margin-top:2rem; display:flex; flex-wrap:wrap; gap:1rem; align-items:center;">
  ...
  <div class="hero-potager__visuel" style="flex:1 1 260px; position:relative;" data-layer="depth-2">
    <div style="position:relative; padding:2rem; border-radius:1.5rem; background:linear-gradient(145deg, rgba(22,28,40,0.96), rgba(70,110,130,0.96)); box-shadow:0 24px 60px rgba(0,0,0,0.35); color:#f4f7fb; backdrop-filter:blur(12px); border:1px solid rgba(255,255,255,0.08);" data-hover="expand">
    ...
    <div style="position:absolute; inset:auto -12% -8% auto; max-width:220px; transform:rotate(-3deg);" data-depth="5">
      <blockquote style="font-size:0.9rem; padding:0.75rem 1rem; border-radius:1rem; backdrop-filter:blur(8px); background:rgba(22,28,40,0.9); border:1px solid rgba(255,255,255,0.12);">
...
<section style="padding:3rem 0 2rem 0;" data-scroll="parallax">
  <h2><span class="split">Pourquoi</span> ce projet ?</h2>
...
<section class="layout-zonage" style="margin:4rem 0;" data-scroll="parallax">
  <div style="display:grid; grid-template-columns:minmax(0,2fr) minmax(0,2fr); gap:1.5rem; align-items:start;">
    <div data-depth="2">
      <h2 data-hover="expand"><span class="split">Lire le lieu</span> avant d’y planter</h2>
      <p>
        Avant les plantations, le potager perpétuel commence par un <strong>geste d’écoute</strong>&nbsp;: observer les courbes du terrain, les vents dominants, les zones d’ombre, les passages de l’eau, les traces déjà laissées par le vivant.
      </p>
      <p>
        Ce travail de lecture permet de dessiner un <strong>design sobre et intelligent</strong>, qui s’appuie sur la topographie plutôt que de la contraindre, et accueille le potager comme une extension naturelle du paysage existant.
      </p>
    </div>
    ...
    <div data-layer="depth-3" style="position:relative;">
      ...
      <div style="position:absolute; top:-10%; left:-6%; max-width:180px; transform:rotate(-4deg);" data-depth="4">
        <div style="padding:0.75rem 1rem; border-radius:999px; font-size:0.8rem; backdrop-filter:blur(10px); background:rgba(22,28,40,0.92); color:#f5f7fa; border:1px solid rgba(255,255,255,0.12);">
...
<section data-scroll="parallax" style="padding:2rem 0 1rem 0;">
  <h2>📚 Objectifs pédagogiques et éducatifs</h2>

  <h3>Comprendre le vivant</h3>
  <p data-hover="expand">
...
L’idée : faire ressentir que chaque racine, chaque insecte, chaque couche de terre participe à l’équilibre du lieu, comme les voix d’un même chœur.
  ...
  <h3>Sensibiliser aux pratiques agroécologiques</h3>
  <p data-hover="expand">
...
Cette approche s’inspire du jardinage durable, de la permaculture et de l’agroforesterie, en les rendant accessibles au plus grand nombre, sans jargon ni technicisme inutile.
  ...
  <h3>Favoriser l’engagement collectif et local</h3>
  <p data-hover="expand">
...
on participe à le faire naître, évoluer et s’enraciner dans le paysage local.
  ...
  <h3>Créer un “laboratoire vivant” sur le long terme</h3>
  <p data-hover="expand">
...
<section data-scroll="parallax" data-layer="depth-2" style="padding:2rem 0 1rem 0;">
  <h2>🛠️ Principes et organisation du projet</h2>

  <h3>Un design agroécologique</h3>
  <p data-hover="expand">
...
data: {
  ...
  <h3>Une gestion écologique des sols et de l’eau</h3>
  <p data-hover="expand">
...
L’objectif : faire mieux avec moins, en s’appuyant sur l’intelligence du paysage plutôt que sur la mécanique et la chimie.
  ...
  <h3>Une participation collective au cœur du projet</h3>
  <p data-hover="expand">
...
La parcelle se transforme, mais le lien social aussi.
  ...
  <h3>Un projet évolutif et pérenne</h3>
  <p data-hover="expand">
...
<section data-scroll="parallax" style="padding:2rem 0 1rem 0;">
  <h2>🌱 Valeur ajoutée et portée du projet</h2>

  <h3>Un outil pédagogique concret</h3>
  <p data-hover="expand">
...
dès lors qu’on dispose d’une vision, de temps et de forces collectives.
  ...
  <h3>Un lieu de lien social et de partage</h3>
  <p data-hover="expand">
...
et on y revient pour les rencontres qu’il rend possibles.
  ...
  <h3>Un modèle inspirant et reproductible</h3>
  <p data-hover="expand">
...
<section data-scroll="parallax" data-layer="depth-3" style="padding:2rem 0 3rem 0;">
  <h2>✅ Pourquoi soutenir ce projet</h2>

  <h3>Un fort impact pédagogique</h3>
  <p data-hover="expand">
...
Les notions abstraites deviennent visibles, palpables, incarnées dans un lieu.
  ...
  <h3>Un coût modéré pour un impact durable</h3>
  <p data-hover="expand">
...
Chaque arbre planté, chaque haie créée est un patrimoine vivant pour le territoire.
  ...
  <h3>Un projet aligné avec des valeurs fortes</h3>
  <p data-hover="expand">
...
plus sobre, plus juste, plus vivant.
  ...
  <h3>Un potentiel de diffusion</h3>
  <p data-hover="expand">
